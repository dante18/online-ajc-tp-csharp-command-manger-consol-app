...
namespace TpCommandManagerDbContext.Migrations
{
    ...
    [Migration("20250907132822_changement_produitcommande")]
    partial class changement_produitcommande
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TpCommandManagerDbContext.Entities.ProduitCommande", b =>
                {
                    b.HasOne("TpCommandManagerDbContext.Entities.Commande", "Commande")
                        .WithMany("ProduitCommande")
                        .HasForeignKey("CommandeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TpCommandManagerDbContext.Entities.Produit", "Produit")
                        .WithMany("ProduitCommande")
